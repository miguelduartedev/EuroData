...
export const metrics: MetricDefinition[] = [
  { id: "gdp_per_capita", label: "GDP per capita", unit: "PPS per inhabitant", description: "Gross domestic product per inhabitant in purchasing power standards.", rankDirection: "higher" },
